...
function stray_tools(){
    ...
    <input type="checkbox" name="websource" value="Y" <?php echo ($websource_selected); ?> />&nbsp;<?php _e('If checked, will add a link to the web page as source for the quote.', 'stray-quotes'); ?><br/><span class="setting-description"><?php _e('Note: no matter how do you change these options, the bookmarklet will stay the same. No need to replace it in your browser\'s toolbar', 'stray-quotes'); ?>.
